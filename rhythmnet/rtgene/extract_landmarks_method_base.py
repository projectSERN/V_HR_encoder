...
from .download_tools import download_external_landmark_models

# noinspection PyUnresolvedReferences
from . import gaze_tools
...
class LandmarkMethodBase(object):
    ...
    def load_face_landmark_model(self, checkpoint_fp=None):
        ...
        cudnn.benchmark = False # modified as running into "RuntimeError: no valid convolution algorithms available in CuDNN"
